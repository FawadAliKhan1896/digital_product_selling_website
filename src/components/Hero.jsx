...
const Hero = () => {
  return (
    ...
    dark:text-white' id='hero'>
        ...
        xl:leading-[95px] max-w-5xl'>Elevating your business with <span className='bg-gradient-to-r from-[#5044e5] to-[#4d8cea] bg-clip-text text-transparent'> FUWS</span> digital excellence.
        </h1>
